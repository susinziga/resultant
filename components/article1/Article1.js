...
import { ArticleContainer, Text, HeadingContainer, Image, DesktopFlex, HeadingLine } from './Articel1.styled';
...
const Article1 = () => {
  ...
  return (
    ...
    <ArticleContainer>
        ...
        <Image className='mobile' src="/articleImage1.png"></Image>
        <Image className='desktop' src="/articleImage1_desktop.png"></Image>
        </DesktopFlex>
    </ArticleContainer>
    </>
  )
