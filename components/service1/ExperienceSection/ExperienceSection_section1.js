...
import {ArrowContainer, Bullet, Button, ButtonContainer, DesktopTitle, ExperienceContainer, ExperienceTitle, FlexDesktop, FlexDesktopText, List} from './ExperienceSection.styled';
...
const ExperienceSection_service1 = (props) => {
  ...
  const Cards = [
    {heading: t("service1:service1_cardHeading1"), text: t("service1:service1_cardText1"), image: "./Service1/CardImage1.png", desktopImage: "./Service1/CardImage1_desktop.png", color: "#F9F4F0"},
    {heading: t("service1:service1_cardHeading2"), text: t("service1:service1_cardText2"), image: "./Service1/CardImage2.png", desktopImage: "./Service1/CardImage2_desktop.png", color: "#DEE6ED"},
  ]
