...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Razvijamo sodobne HR rešitve | Resultant</title>
        <meta
          name="description"
          content="Razvijamo sodobne HR rešitve, gradimo učinkovite procese in povečujemo organizacijsko uspešnost. Zaupa nam več kot 150 podjetij. Želite razvoj? Spoznajte nas."
        />
      </Head>
